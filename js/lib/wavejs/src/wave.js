import { colorHex, colorRgb } from "./untils";
export default class Wave {
    ...
    draw() {
        ...
        this.lines.forEach((line, index) => {
            ...
            if (this.options.position === 'left' || this.options.position === 'right') {
                ctx.bezierCurveTo(height + leftHeight - this.options.smooth, canvas.height / 2, height + rightHeight - this.options.smooth, canvas.width / 2, vertexs[1][0], vertexs[1][1]);
            }
            else {
                ctx.bezierCurveTo(canvas.width / 2, height + leftHeight - this.options.smooth, canvas.width / 2, height + rightHeight - this.options.smooth, vertexs[1][0], vertexs[1][1]);
            }
            if (this.options.border.show) {
                ctx.stroke();
            }
    ...
    getVertexs(leftHeight, rightHeight) {
